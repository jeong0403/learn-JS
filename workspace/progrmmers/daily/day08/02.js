...
(10 × 4 + 1)**2 = 41**2 = 1681점을 얻습니다. 따라서 1681을 return 합니다.
...
// console.log(solution(16, 4, 2, 15)); // 두 자리 이상의 숫자를 비교하는 상황에서 sort메서드 썼을 때 [15, 16, 2, 4]로 문자열로 바꿔서 순서대로 비교해버림 그래서 sort함수 안에 콜백 함수 지정해서 쓰면 정렬 순서를 오름차순 혹은 내림차순으로 변경할 수 있다. 